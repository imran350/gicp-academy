...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* CTA Banner */}
      <section className="grain relative overflow-hidden bg-gradient-to-br from-brand-teal-dark to-brand-teal py-20">
        <div
          className="pointer-events-none absolute inset-0"
          style={{
            background:
              'radial-gradient(ellipse 70% 50% at 70% 50%, rgba(217,119,6,0.15), transparent)',
          }}
        />
